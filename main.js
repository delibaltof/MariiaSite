...
function renderNavbar() {
 ...
 const logoText = `<img src="images/logo.png" alt="mariiaeats">`
  ...
  qs('.nav-cta').textContent    = 'Work With Me'
  qs('.drawer-cta').textContent = 'Work With Me'
}
...
/* ============================================================
   ...
   ============================================================ */
function renderHero() {
  qs('.hero-h1').innerHTML = `Transform your body,<em>your life.</em>`
  qs('.hero-sub').textContent = SITE.subheadline

  qs('.hero-btns').innerHTML = `
    <a href="#contact" class="btn btn-pink">Start Your Journey</a>
    <a href="#services" class="btn btn-ghost">See My Services →</a>
  `
